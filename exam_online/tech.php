                            ...
                            <div class="student-card">
                                <div class="student-info">
                                    ...
                                    <div class="student-details">
                                        ...
                                        <p><i class="fas fa-graduation-cap"></i> <?= htmlspecialchars($student['fillier'] ?? 'Not specified') ?></p>
                                        <p><i class="fas fa-users"></i> Group: <?= htmlspecialchars($student['group_column'] ?? 'Not assigned') ?></p>
