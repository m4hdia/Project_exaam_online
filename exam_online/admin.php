...
if ($userType !== 'all') $query .= " AND user_type = :user_type";
                    ...
                    <tbody>
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td><?php echo $user['fillier'] ? ucfirst($user['fillier']) : '-'; ?></td>
                                <td><?php echo $user['group_column'] ? ucfirst($user['group_column']) : '-'; ?></td>
                                <td>
